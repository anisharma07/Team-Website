...
import EventCardm from "../../components/CardM";
import StatusTag from "../../components/StatusTag";
import { prevEvents } from "../../components/constants";

const ContainerM = ({ eventsData }) => {
  return (
    <div className="w-full flex flex-col items-center">
      ...
      <div
        id="upcoming-events"
        className="flex flex-col w-[full] items-center mt-[100px]"
      >
        <div className="text-[#4ED4FF] text-[45px] font-bold font-aldrich ssm:text-[33px] leading-0 relative">
          This Year's Events
          <p
            className="text-[#ffffff] text-[40px] absolute top-[-90px] left-[50px] ssm:left-[60px] z-[1000] londrina-solid-font font-[600] flex items-center gap-4 ssm:gap-2"
      ...
      <br />
      <br />
      <StatusTag scroll_id="Past-Year-Events" section_status="2022 - 2023" />

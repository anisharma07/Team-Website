...
import EventCardl from "@app/our-work/components/CardL";
import { prevWorkshops } from "../../components/constants";

const WorkshopL = ({ eventsData }) => {
  return (
    <div className="w-full flex flex-col items-center">
      <div
        id="exe-workshops"
        className="text-[#ffffff] text-[60px] londrina-solid-font font-[600] flex items-center gap-4 mb-[50px]"
